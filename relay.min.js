...
function __relay_caller__(){function a(a){return{"&":"&amp;","<":"&lt;",">":"&gt;"}[a]||a}try{throw Error("");}catch(b){for(var c=null,e=b.stack.split("\n"),d=0;d<e.length;d++){var f=/[^\(]*\(([^\)]*)\)/ig.exec(e[d]);if(f&&2<=f.length&&(f=/\/specs\/([^\.]+\.js:[0-9]+:[0-9]+)$/ig.exec(f[1]))&&2<=f.length){c=f[1].replace(/[&<>]/g,a);break}}return c}}function __relay_broadcast__(a,b){for(var c=0;c<relay().listeners.length;c++)relay().listeners[c][a](b)};var RelayListener=function(){};RelayListener.prototype={onRelayStart:function(){},onRelayEnd:function(){},onEnter:function(){},onExit:function(){}};function RelayObject(a){this.id=a.id;this.parent=a.parent}RelayObject.prototype.findFirstParent=function(a){if(!a)return element.parent;for(var b=this.parent;null!=b&&!a(b);)b=b.parent;return b};RelayObject.prototype.typeString=function(){if(this&&this.constructor&&this.constructor.toString){var a=this.constructor.toString().match(/function\s*(\w+)/);if(a&&2==a.length)return a[1]}};__relay_extend__(RelayObject,Run);function Run(a){RelayObject.call(this,a);this.func=a.func;this.expects=[];a.befores&&(this.befores=a.befores);a.afters&&(this.afters=a.afters)}Run.prototype.perform=function(a){var b=this,c=!1;b.func(function(){c?console.error("Relay asynchronous block received called back more than once"):(c=!0,__relay_loop__(0,b.expects.length,function(a,c){__relay_enter__(b.expects[a],c)},function(){a()}))})};
